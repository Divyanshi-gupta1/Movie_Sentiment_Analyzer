...
This project analyzes textual movie reviews and classifies them based on sentiment polarity.  
It uses machine learning algorithms and Python libraries such as **pandas**, **numpy**, and **scikit-learn** to process and evaluate the reviews efficiently.
